...
A1_REACTION_FAST_MOVE_ENABLED = True
A1_REACTION_FAST_MOVE_WINDOW_SEC = 3.0
A1_REACTION_FAST_MOVE_MIN_DISTANCE_U = 1.0
A1_REACTION_FAST_MOVE_MIN_DISTANCE_PCT = 0.0003
A1_REACTION_FAST_MOVE_MIN_ACTIVE_NOTIONAL_3S = 0.0

A1_REACTION_EVENT_RECORDER_ENABLED = True
A1_REACTION_EVENT_RECORDER_WRITE_JSONL = False
A1_REACTION_EVENT_RECORDER_JSONL_PATH = "logs/research/a1_reaction_events.jsonl"
A1_REACTION_EVENT_RECORDER_MAX_RECENT_EVENTS = 5000

V62_LOG_A1_REACTION_RESEARCH_EVENT_ENABLED = True
