...
# Unit: U per 1M notional.
A1_CLUSTER_MAX_PRICE_EFFICIENCY = _float_config("A1_CLUSTER_MAX_PRICE_EFFICIENCY", 1.0)
...
V7_3A_SIMULATOR_INCLUDE_UNAVAILABLE = _bool_config("V7_3A_SIMULATOR_INCLUDE_UNAVAILABLE", False)
V7_3A_SIMULATOR_MAX_TRADES = _int_config("V7_3A_SIMULATOR_MAX_TRADES", 0)
V7_3A_SIMULATOR_INPUT_SCOPE = _str_config("V7_3A_SIMULATOR_INPUT_SCOPE", "ICEBERG_ONLY").upper()

# V7.3.0 no-future runtime 3A research backtest configuration.
A2_RT_MIN_QUIET_SEC = _float_config("A2_RT_MIN_QUIET_SEC", 3.0)
A2_RT_MIN_TICK_COUNT = _int_config("A2_RT_MIN_TICK_COUNT", 20)
A2_RT_MAX_AGE_SEC = _float_config("A2_RT_MAX_AGE_SEC", 900.0)
A2_RT_EXPIRY_SWEEP_SECS = _int_list_config("A2_RT_EXPIRY_SWEEP_SECS", [180, 300, 600, 900, 1200, 1800])
A2_RT_MAX_BOX_WIDTH_U = _float_config("A2_RT_MAX_BOX_WIDTH_U", 3.0)
A2_RT_MAX_BOX_WIDTH_MULTIPLIER = _float_config("A2_RT_MAX_BOX_WIDTH_MULTIPLIER", 2.0)
...
A3_RT_MIN_DELTA_NOTIONAL = _float_config("A3_RT_MIN_DELTA_NOTIONAL", 100000.0)
A3_RT_MIN_BURST_NOTIONAL = _float_config("A3_RT_MIN_BURST_NOTIONAL", 150000.0)
A3_RT_BURST_MULTIPLIER = _float_config("A3_RT_BURST_MULTIPLIER", 2.0)
A3_RT_PRICE_VELOCITY_MIN_U_PER_SEC = _float_config("A3_RT_PRICE_VELOCITY_MIN_U_PER_SEC", 0.2)

V7_3A_RT_ENABLED = _bool_config("V7_3A_RT_ENABLED", True)
V7_3A_RT_TARGET_MODEL = _str_config("V7_3A_RT_TARGET_MODEL", "TARGET_FIXED_2R")
V7_3A_RT_STOP_MODEL = _str_config("V7_3A_RT_STOP_MODEL", "STOP_STRUCTURAL_ZONE_V2")
V7_3A_RT_NEXT_TICK_ENTRY = _bool_config("V7_3A_RT_NEXT_TICK_ENTRY", False)
V7_3A_RT_MAX_FEE_SHARE_R = _float_config("V7_3A_RT_MAX_FEE_SHARE_R", 1.0)
V7_3A_RT_ENABLE_NO_FUTURE_AUDIT = _bool_config("V7_3A_RT_ENABLE_NO_FUTURE_AUDIT", True)
