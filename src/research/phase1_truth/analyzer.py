...
GRID_START = [300000, 500000, 700000, 900000, 1200000, 1500000, 2000000]
GRID_HIDDEN = [750000, 1000000, 1500000, 2000000, 3000000, 4000000]
GRID_ABS = [0.50, 0.60, 0.70, 0.80, 0.90, 1.20, 2.00]
GRID_DEPTH = [1000000, 2000000, 5000000, 8000000, 12000000, 20000000]
