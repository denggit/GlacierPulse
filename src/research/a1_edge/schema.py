...
class ForwardMetricResult:
    ...
    net_directional_mfe_r: float = 0.0
    net_directional_mae_r: float = 0.0
    ...
    net_hit_plus_1r: bool = False
    net_hit_plus_2r: bool = False
    net_hit_plus_3r: bool = False
    net_hit_minus_1r: bool = False
...
class HypothesisResult:
    ...
    hit_2r: bool = False
    hit_3r: bool = False
    net_hit_1r: bool = False
    net_hit_2r: bool = False
    net_hit_3r: bool = False
    hit_stop: bool = False
    first_hit_plus_1r: bool = False
    first_hit_minus_1r: bool = False
