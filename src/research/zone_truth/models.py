...
class ZoneTruthEvent:
    ...
    a1_evidence_v2_available: bool = False
    a1_primary_evidence_type: str = "NO_A1_EVIDENCE_V2"
    a1_evidence_types: str = ""
    a1_evidence_score_v2: float = 0.0
    hidden_reload_iceberg_flag: bool = False
    visible_wall_absorption_flag: bool = False
    cluster_absorption_flag: bool = False
    ladder_absorption_flag: bool = False
    failed_wall_flag: bool = False
    spoofing_withdrawal_flag: bool = False
    visible_wall_start_depth_usdt: float = 0.0
    visible_wall_end_depth_usdt: float = 0.0
    visible_wall_consumption_ratio: float = 0.0
    visible_wall_survival_ratio: float = 0.0
    visible_wall_withdrawal_excess_ratio: float = 0.0
    visible_wall_absorbed_notional_proxy: float = 0.0
    cluster_best_window_sec: int = 0
    cluster_best_active_notional: float = 0.0
    cluster_best_event_count: int = 0
    cluster_best_price_efficiency: float = 0.0
    ladder_level_count: int = 0
    ladder_core_low: float = 0.0
    ladder_core_high: float = 0.0
    ladder_sweep_extreme: float = 0.0
    ladder_absorption_score: float = 0.0
    a1_evidence_v2_reason: str = ""
    observation_zone_lower: float = 0.0
    observation_zone_upper: float = 0.0
    absorption_core_lower: float = 0.0
    absorption_core_upper: float = 0.0
    absorption_core_width: float = 0.0
    sweep_extreme_low: float = 0.0
    sweep_extreme_high: float = 0.0
    defended_low: float = 0.0
    defended_high: float = 0.0
    zone_v2_structural_stop_price: float = 0.0
    zone_v2_structural_risk_u: float = 0.0
    zone_v2_boundary_reason: str = ""
    zone_v2_core_recovery_ratio_avg: float = 0.0
    zone_v2_core_recovery_ratio_min: float = 0.0
    zone_v2_core_end_vs_start_avg: float = 0.0
    zone_v2_over_reload_count: int = 0
    zone_v2_reload_level_count: int = 0
    zone_v2_layered_absorption_flag: bool = False
    zone_v2_book_coverage_low: float = 0.0
    zone_v2_book_coverage_high: float = 0.0
    zone_v2_book_coverage_sufficient_flag: bool = False
    ...
    a2_net_mfe_15m_r_future: float = 0.0
    a2_net_mae_15m_r_future: float = 0.0
    a2_net_mfe_1h_r_future: float = 0.0
    a2_net_mae_1h_r_future: float = 0.0
    a2_net_mfe_4h_r_future: float = 0.0
    a2_net_mae_4h_r_future: float = 0.0
    a2_net_hit_1r_15m_future: bool = False
    a2_net_hit_1r_1h_future: bool = False
    a2_net_hit_2r_1h_future: bool = False
