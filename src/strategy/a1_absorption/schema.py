...
class A1AbsorptionContext:
    ...
    def from_public_zone(cls, zone: Mapping[str, Any]) -> "A1AbsorptionContext":
        return cls(
            ...
            frozen_low=_as_float(zone.get("frozen_low", zone.get("frozen_zone_lower"))),
            frozen_high=_as_float(zone.get("frozen_high", zone.get("frozen_zone_upper"))),
            live_low=_as_float(zone.get("live_low", zone.get("live_zone_lower"))),
            live_high=_as_float(zone.get("live_high", zone.get("live_zone_upper"))),
