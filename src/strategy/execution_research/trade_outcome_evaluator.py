...
class ExecutionResearchOutcomeEvaluator:
    ...
    def _best_group(
        ...
        candidates = ExecutionResearchOutcomeEvaluator._group_candidates(
            groups=groups,
            prefix=prefix,
    ...
    def _ratio(numerator: Any, denominator: Any) -> float:
        denom = ExecutionResearchOutcomeEvaluator._as_float(denominator)
        if denom == 0:
            return 0.0
        return ExecutionResearchOutcomeEvaluator._as_float(numerator) / denom
