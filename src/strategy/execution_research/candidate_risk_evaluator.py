...
# -*- coding: utf-8 -*-
"""
V6.3 execution research candidate evaluator.

This module is research-only. It consumes A1 reaction / legacy PHASE2 confirmed
snapshots and builds execution research candidates. It never calls trader,
creates orders, or creates virtual positions.

Compatibility note:
Legacy Phase3 class names, PHASE3 log tags, phase2_type fields, and
PHASE2_CONFIRMED input state checks are intentionally preserved because
downstream V6.2/V6.3 tests, logs, and research pipelines still depend on them.
"""
